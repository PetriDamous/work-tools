$(document).ready(function() {
    ...
    function disableMenuAction () {
        var slideLabel = cpInfoCurrentSlideLabel.toLocaleLowerCase();
        var label_1 = slideLabel.indexOf("question");
        var label_2 = slideLabel.indexOf("interaction");
        return (label_1 !== -1) || (label_2 !== -1);
    }
